 ...
 */
public class MoreSearchAndSendContactActivityTest extends ActivityUnitTestCase<MoreSearchAndSendContactActivity> {
    ...
    protected void setUp() throws Exception {
        ...
        Intent intent = new Intent(getInstrumentation().getTargetContext(), MoreSearchAndSendContactActivity.class);
