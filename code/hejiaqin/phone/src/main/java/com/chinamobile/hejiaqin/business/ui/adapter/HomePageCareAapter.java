 ...
 * Created: 2016/5/17.
 */
public class HomePageCareAapter extends RecyclerView.Adapter {
    ...
    public HomePageCareAapter(Context context,PopClickListen popClickListen) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_home_page_care, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (info != null) {
            ...
            {
                tHolder.homeCareLayout.setBackgroundResource(R.drawable.home_care_top_bg);
            }
            else
            {
                tHolder.homeCareLayout.setBackgroundResource(R.drawable.home_small_item_bg);
            }
            tHolder.nameTv.setText(info.getTitle());
            tHolder.homeCareLayout.setTag(position);
            //我的
            if (BussinessConstants.DictInfo.PRACTICE_TYPE_MY.equals(info.getType())) {
                ...
                tHolder.numTv.setText(String.valueOf(totalnum));
    ...
    public class HolderView extends RecyclerView.ViewHolder {
        public LinearLayout homeCareLayout;
        ...
        public HolderView(View view) {
            super(view);
            homeCareLayout = (LinearLayout) view.findViewById(R.id.home_care_layout);
    ...
    private void showpPopwindow(View v, final MyPracticeInfo info, final boolean cancelTop) {
        ...
        popView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                HomePageCareAapter.this.notifyDataSetChanged();
                HomePageCareAapter.this.mPopClickListen.update(info);
                popupWindow.dismiss();
            }
        });
