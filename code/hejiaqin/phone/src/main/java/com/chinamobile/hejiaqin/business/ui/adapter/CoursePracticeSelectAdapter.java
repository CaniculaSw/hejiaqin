 ...
 * Created: 2016/5/4.
 */
public class CoursePracticeSelectAdapter extends RecyclerView.Adapter {
    ...
    public CoursePracticeSelectAdapter(Context context, String[] data,OnCoursePracticeChangeListener listener) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        int index = StorageMgr.getInstance().getSharedPStorage(mContext.getApplicationContext()).getInt(BussinessConstants.Courses.COURSE_PRACTICE_SELECT_INDEX);
        if(index < 0){
            index = 0;
        }
        if(index == position){
    ...
    class ClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(mData != null) {
                CourseCacheManager.saveCoursePracticeToLoacl(mContext.getApplicationContext(), position, mData[position]);
