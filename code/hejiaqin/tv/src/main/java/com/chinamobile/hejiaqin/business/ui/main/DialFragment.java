...
public class DialFragment extends BasicFragment implements View.OnClickListener {
    ...
    protected void initView(View view) {
        ...
        dialSaveContactArrowLayout = (LinearLayout) view
                .findViewById(R.id.dial_save_contact_arrow_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dial_save_contact_arrow_layout:
                // 保存联系人
                if (inputNumber.length() > 0) {
                    ContactEditFragment fragment = ContactEditFragment.newInstance(inputNumber
    ...
    private void delNum() {
        ...
        if (length == inputNumber.getSelectionStart() && length == inputNumber.getSelectionEnd()) {
            inputNumber.setCursorVisible(false);
        }
    }
