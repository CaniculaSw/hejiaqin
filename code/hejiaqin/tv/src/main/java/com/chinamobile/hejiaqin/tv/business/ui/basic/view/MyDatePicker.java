package com.chinamobile.hejiaqin.tv.business.ui.basic.view;
...
public class MyDatePicker extends FrameLayout {
    ...
    abstract static class AbstractDatePickerDelegate implements DatePickerDelegate {
        // The delegator
        protected MyDatePicker mDelegator;
        ...
        public AbstractDatePickerDelegate(MyDatePicker delegator, Context context) {
    ...
    private static class DatePickerSpinnerDelegate extends AbstractDatePickerDelegate {
        ...
        DatePickerSpinnerDelegate(MyDatePicker delegator, Context context, AttributeSet attrs,
                                  int defStyleAttr, int defStyleRes) {
...
//            mYearSpinnerInput = (EditText) mYearSpinner.findViewById(R.id.numberpicker_input);
            ...
            setDatePickerDividerColor(mDaySpinner);
            setDatePickerDividerColor(mMonthSpinner);
            setDatePickerDividerColor(mYearSpinner);
...
//            InputMethodManager inputMethodManager = InputMethodManager.peekInstance();
        ...
        private NumberPicker.Formatter getTwoDigitFormatter() {
            try {
