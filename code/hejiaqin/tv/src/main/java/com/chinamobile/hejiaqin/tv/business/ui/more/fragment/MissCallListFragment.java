package com.chinamobile.hejiaqin.tv.business.ui.more.fragment;
...
import com.chinamobile.hejiaqin.tv.business.ui.more.adapter.MissCallAdapter;
...
public class MissCallListFragment extends BasicFragment implements View.OnClickListener {
    ...
    private void deleteSelectedData() {
        Iterator<MissCallMessage> it = mMissCallMessages.iterator();
        while (it.hasNext()) {
    ...
    private void unSelectedAllData() {
        for (MissCallMessage missCallMsg : mMissCallMessages) {
