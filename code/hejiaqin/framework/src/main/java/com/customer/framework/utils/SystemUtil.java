...
public final class SystemUtil {
    ...
    public static boolean openApk(Context context, String packageName) {
        try {
            ...
            Log.e(TAG, "open apk failed, the apk package is: " + packageName, e);
        }
        return false;
    }
    ...
    public static void unInstallAPK(Context context, String packageName) {
        try {
            ...
            Log.e(TAG, "unInstallApk failed, apk package is : " + packageName, e);
        }
    }
    ...
    public static void enableHttpResponseCache(Context context, long cacheSize) {
        try {
            ...
            Class.forName(RESP_CACHE_CLASS_NAME).getMethod("install", File.class, long.class)
    ...
    public static void flushRespCache() {
        try {
            Object respCache = Class.forName(RESP_CACHE_CLASS_NAME).getMethod("getInstalled")
                    .invoke(null);
            if (respCache == null) {
                return;
            }
            Class.forName(RESP_CACHE_CLASS_NAME).getMethod("flush").invoke(respCache);
        } catch (Exception e) {
    ...
    public static void printCachehitCount() {
        try {
            ...
            Object returnValue = Class.forName(RESP_CACHE_CLASS_NAME).getMethod("getHitCount")
                    .invoke(respCache);
            Log.i(TAG, "printRespCacheHitCount:" + ((Integer) returnValue).intValue());
        } catch (Exception e) {
