...
public class BussinessConstants {
    ...
    public interface Dial {
        ...
        String TV_MAIN_FRAGMENT = "android.intent.action.hejiaqin.tv.mainfragment";
    ...
    public interface DialMsgID {
        ...
        int CALL_INCOMING_FINISH_CLOSING_MSG_ID = BASE_MSG_ID + 14;

        // 搜索联系人成功的消息ID
        int SEARCH_CONTACTS_SUCCESS_MSG_ID = BASE_MSG_ID + 15;
        int CALL_RECORD_SEARCH_MSG_ID = BASE_MSG_ID + 16;

        int NURSE_CALL_ON_TALKING_MSG_ID = BASE_MSG_ID + 17;
        int NURSE_CALL_CLOSED_MSG_ID = BASE_MSG_ID + 18;

        int NURSE_ON_TV_INCOMING_MSG_ID = BASE_MSG_ID + 19;
