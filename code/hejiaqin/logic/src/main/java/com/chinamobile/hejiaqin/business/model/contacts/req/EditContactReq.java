 ...
 */
public class EditContactReq extends ReqToken implements ReqBody {
    ...
    public String toBody() {
        ...
        reqBody.add("contactId", getContactId());
...
//        }
//
//        contentDisposition = "Content-Disposition: form-data; name=\"contactId\"";
//        requestBody.append("--").append(BussinessConstants.HttpHeaderInfo.HEADER_BOUNDARY);
//        requestBody.append("\r\n");
//        requestBody.append(contentDisposition);
//        requestBody.append("\r\n\r\n");
